...
"""
This instance provides a minimalistic simulator cli. The simulator receives messages from the exchange by a receiver
thread and saves it to an array. Without deleting the array, new message batches will be concatenated to the existing
array. The array can be saved to a csv file. 
"""
